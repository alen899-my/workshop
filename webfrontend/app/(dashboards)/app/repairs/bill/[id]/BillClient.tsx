...
import { Plus, Trash2, PenTool, Calculator } from "lucide-react";
...
export default function BillClient({ id, initialRepair, initialBill }: BillClientProps) {
  ...
  return (
    <ModuleForm
      ...
      subtitle={`Manage parts, replacements, and service charges for vehicle ${initialRepair?.vehicle_number}.`}
      backUrl="/app/repairs"
