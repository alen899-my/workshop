          ...
          <View style={styles.grid}>
            ...
            >
              <View style={[styles.iconBox, { backgroundColor: Colors.info + '18' }]}>
                <Ionicons name="construct-outline" size={22} color={Colors.info} />
              </View>
...
const styles = StyleSheet.create({
  ...
  handle: { width: 44, height: 5, borderRadius: 2.5, backgroundColor: Colors.border },
  tealHeaderCard: {
  ...
  vehicleNo: { fontSize: 22, fontWeight: '900', color: Colors.textInverse },
  ...
  gridButtonText: { fontSize: 13, fontWeight: '700', color: Colors.text, textAlign: 'center' },
  cancelBtn: {
    height: 50, borderRadius: 14, borderWidth: 1.5, borderColor: Colors.primary,
    backgroundColor: 'transparent', alignItems: 'center', justifyContent: 'center',
  },
  cancelText: { fontSize: 14, fontWeight: '800', color: Colors.primary },
  pressed: { opacity: 0.8 },
});
